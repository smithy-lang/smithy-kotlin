...
class FunctionMinTest {
    @Test fun testMinFunctionShortListEquals() = successTest(
    ...
    @Test fun testMinFunctionIntegerListEquals() = successTest(
        GetFunctionMinEqualsRequest { name = "test" },
    ...
    @Test fun testMinFunctionLongListEquals() = successTest(
        GetFunctionMinEqualsRequest { name = "test" },
    ...
    @Test fun testMinFunctionFloatListEquals() = successTest(
        GetFunctionMinEqualsRequest { name = "test" },
    ...
    @Test fun testMinFunctionDoubleListEquals() = successTest(
        GetFunctionMinEqualsRequest { name = "test" },
    ...
    @Test fun testMinFunctionStringListEquals() = successTest(
        GetFunctionMinEqualsRequest { name = "test" },
