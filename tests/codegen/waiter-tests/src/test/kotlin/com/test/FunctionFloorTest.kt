...
class FunctionFloorTest {
    @Test
    fun testFloorFunctionShortEquals() = successTest(
    ...
    @Test
    fun testFloorFunctionIntegerEquals() = successTest(
        GetFunctionFloorRequest { name = "test" },
    ...
    @Test
    fun testFloorFunctionLongEquals() = successTest(
        GetFunctionFloorRequest { name = "test" },
    ...
    @Test
    fun testFloorFunctionFloatEquals() = successTest(
        GetFunctionFloorRequest { name = "test" },
    ...
    @Test
    fun testFloorFunctionDoubleEquals() = successTest(
        GetFunctionFloorRequest { name = "test" },
