...
class StringEqualsTest {
    // anyStringEquals
    @Test
    fun testStringListAnyListStringEquals() = successTest(
    ...
    @Test
    fun testEnumListAnyStringEquals() = successTest(
        GetStringEqualsRequest { name = "test" },
    ...
    // allStringEquals
    @Test
    fun testStringListAllStringEquals() = successTest(
        GetStringEqualsRequest { name = "test" },
    ...
    @Test
    fun testEnumListAllStringEquals() = successTest(
        GetStringEqualsRequest { name = "test" },
