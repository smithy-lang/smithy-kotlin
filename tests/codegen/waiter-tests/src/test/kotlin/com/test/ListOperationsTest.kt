...
class ListOperationsTest {
    // list indexing
    @Test
    fun testBooleanListIndexZeroEquals() = successTest(
    ...
    @Test
    fun testBooleanListIndexOneEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    @Test
    fun testBooleanListIndexNegativeTwoEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    @Test
    fun testTwoDimensionalBooleanListIndexZeroZeroEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    @Test
    fun testStructListIndexOneStringsIndexZeroEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    @Test
    fun testStructListIndexOneSubStructsIndexZeroSubStructPrimitivesBooleanEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    // list slicing
    @Test
    fun testStringListStepSlicingEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    @Test
    fun testStringListStopSlicingEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    @Test
    fun testStringListStartSlicingEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    @Test
    fun testStringListStopStepSlicingEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    @Test
    fun testStringListStartStepSlicingEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    @Test
    fun testStringListStartStopSlicingEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    @Test
    fun testStringListStartStopStepSlicingEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    @Test
    fun testStringListNegativeStartStopSlicingEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    @Test
    fun testStringListStartNegativeStopSlicingEquals() = successTest(
        GetListOperationRequest { name = "test" },
    ...
    @Test
    fun testStringListStopNegativeStartSlicingEquals() = successTest(
        GetListOperationRequest { name = "test" },
