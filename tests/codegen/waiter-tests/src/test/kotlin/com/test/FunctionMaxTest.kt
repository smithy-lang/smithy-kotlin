...
class FunctionMaxTest {
    @Test
    fun testMaxFunctionShortListEquals() = successTest(
    ...
    @Test
    fun testMaxFunctionIntegerListEquals() = successTest(
        GetFunctionMaxEqualsRequest { name = "test" },
    ...
    @Test
    fun testMaxFunctionLongListEquals() = successTest(
        GetFunctionMaxEqualsRequest { name = "test" },
    ...
    @Test
    fun testMaxFunctionFloatListEquals() = successTest(
        GetFunctionMaxEqualsRequest { name = "test" },
    ...
    @Test
    fun testMaxFunctionDoubleListEquals() = successTest(
        GetFunctionMaxEqualsRequest { name = "test" },
    ...
    @Test
    fun testMaxFunctionStringListEquals() = successTest(
        GetFunctionMaxEqualsRequest { name = "test" },
