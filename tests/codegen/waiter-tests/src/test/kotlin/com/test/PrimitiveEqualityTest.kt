...
class PrimitiveEqualityTest {
    @Test
    fun testBooleanEquals() = successTest(
    ...
    @Test
    fun testBooleanEqualsByCompare() = successTest(
        GetPrimitiveRequest { name = "test" },
    ...
    @Test
    fun testStringEquals() = successTest(
        GetPrimitiveRequest { name = "test" },
    ...
    @Test
    fun testStringEqualsByCompare() = successTest(
        GetPrimitiveRequest { name = "test" },
    ...
    @Test
    fun testByteEquals() = successTest(
        GetPrimitiveRequest { name = "test" },
    ...
    @Test
    fun testShortEquals() = successTest(
        GetPrimitiveRequest { name = "test" },
    ...
    @Test
    fun testIntegerEquals() = successTest(
        GetPrimitiveRequest { name = "test" },
    ...
    @Test
    fun testLongEquals() = successTest(
        GetPrimitiveRequest { name = "test" },
    ...
    @Test
    fun testFloatEquals() = successTest(
        GetPrimitiveRequest { name = "test" },
    ...
    @Test
    fun testDoubleEquals() = successTest(
        GetPrimitiveRequest { name = "test" },
    ...
    @Test
    fun testEnumEquals() = successTest(
        GetPrimitiveRequest { name = "test" },
    ...
    @Test
    fun testEnumEqualsByCompare() = successTest(
        GetPrimitiveRequest { name = "test" },
    ...
    @Test
    fun testIntEnumEquals() = successTest(
        GetPrimitiveRequest { name = "test" },
