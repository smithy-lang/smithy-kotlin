...
description = "Utils for running protocol tests"
extra["displayName"] = "Smithy :: Kotlin :: Protocol Tests :: Utils"
extra["moduleName"] = "software.amazon.smithy.kotlin.pt.util"
