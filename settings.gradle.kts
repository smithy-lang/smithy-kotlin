...
include(":runtime")
include(":runtime:auth:credentials:aws-credentials")
include(":runtime:auth:signing:aws-signing-common")
include(":runtime:auth:signing:aws-signing-crt")
include(":runtime:auth:signing:aws-signing-tests")
