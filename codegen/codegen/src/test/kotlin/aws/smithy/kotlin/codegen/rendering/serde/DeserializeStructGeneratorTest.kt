...
import aws.smithy.kotlin.codegen.test.codegenDeserializerForShape
                        ...
                        PAYLOAD_DESCRIPTOR.index -> builder.payload =
                            deserializer.deserializeList(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = if (nextHasValue()) { deserializeInstant(TimestampFormat.EPOCH_SECONDS) } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                    col0.add(el0)
                                }
                                col0
                            }
                    ...
                    when (findNextFieldIndex()) {
                        PAYLOAD_DESCRIPTOR.index -> builder.payload =
                            deserializer.deserializeList(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = if (nextHasValue()) { deserializeDocument() } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                    col0.add(el0)
                                }
                                col0
                            }
                    ...
                    when (findNextFieldIndex()) {
                        PAYLOAD_DESCRIPTOR.index -> builder.payload =
                            deserializer.deserializeList(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = if (nextHasValue()) { deserializeInt() } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                    col0.add(el0)
                                }
                                col0
                            }
                    ...
                    when (findNextFieldIndex()) {
                        PAYLOAD_DESCRIPTOR.index -> builder.payload =
                            deserializer.deserializeMap(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextEntry()) {
                                    val k0 = key()
                                    val v0 = if (nextHasValue()) { deserializeInt() } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                    map0[k0] = v0
                                }
                                map0
                            }
                    ...
                    when (findNextFieldIndex()) {
                        PAYLOAD_DESCRIPTOR.index -> builder.payload =
                            deserializer.deserializeList(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = if (nextHasValue()) { deserializeFooUnionDocument(deserializer) } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                    col0.add(el0)
                                }
                                col0
                            }
                            ...
                            deserializer.deserializeList(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = deserializer.deserializeList(PAYLOAD_C0_DESCRIPTOR) {
                                        ...
                                        while (hasNextElement()) {
                                            val el1 = if (nextHasValue()) { deserializeString() } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                            col1.add(el1)
                                        }
                                        col1
                                    }
                    ...
                    when (findNextFieldIndex()) {
                        PAYLOAD_DESCRIPTOR.index -> builder.payload =
                            deserializer.deserializeList(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = if (nextHasValue()) { deserializeNestedStructureDocument(deserializer) } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                    col0.add(el0)
                                }
                                col0
                            }
                                    ...
                                    val el0 = deserializer.deserializeList(PAYLOAD_C0_DESCRIPTOR) {
                                        ...
                                        while (hasNextElement()) {
                                            val el1 = deserializer.deserializeList(PAYLOAD_C1_DESCRIPTOR) {
                                                ...
                                                while (hasNextElement()) {
                                                    val el2 = if (nextHasValue()) { deserializeBoolean() } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                                    col2.add(el2)
                                                }
                                                col2
                                            }
                            ...
                            deserializer.deserializeList(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = deserializer.deserializeMap(PAYLOAD_C0_DESCRIPTOR) {
                                        ...
                                        while (hasNextEntry()) {
                                            val k1 = key()
                                            val v1 = if (nextHasValue()) { deserializeString() } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                            map1[k1] = v1
                                        }
                                        map1
                                    }
                            ...
                            deserializer.deserializeList(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = deserializer.deserializeList(PAYLOAD_C0_DESCRIPTOR) {
                                        ...
                                        while (hasNextElement()) {
                                            val el1 = if (nextHasValue()) { deserializeInt() } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                            col1.add(el1)
                                        }
                                        col1
                                    }
                            ...
                            deserializer.deserializeMap(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextEntry()) {
                                    ...
                                    val v0 =
                                        ...
                                        } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                            ...
                            deserializer.deserializeList(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = deserializer.deserializeMap(PAYLOAD_C0_DESCRIPTOR) {
                                        ...
                                        while (hasNextEntry()) {
                                            val k1 = key()
                                            val v1 = if (nextHasValue()) { deserializeBoolean() } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                            map1[k1] = v1
                                        }
                                        map1
                                    }
                    ...
                    when (findNextFieldIndex()) {
                        PAYLOAD_DESCRIPTOR.index -> builder.payload =
                            deserializer.deserializeMap(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextEntry()) {
                                    val k0 = key()
                                    val v0 = if (nextHasValue()) { deserializeString() } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                    map0[k0] = v0
                                }
                                map0
                            }
                    ...
                    when (findNextFieldIndex()) {
                        PAYLOAD_DESCRIPTOR.index -> builder.payload =
                            deserializer.deserializeMap(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextEntry()) {
                                    val k0 = key()
                                    val v0 = if (nextHasValue()) { deserializeFooUnionDocument(deserializer) } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                    map0[k0] = v0
                                }
                                map0
                            }
                                            ...
                                            deserializer.deserializeList(PAYLOAD_C0_DESCRIPTOR) {
                                                ...
                                                while (hasNextElement()) {
                                                    val el1 = deserializer.deserializeMap(PAYLOAD_C1_DESCRIPTOR) {
                                                        ...
                                                        while (hasNextEntry()) {
                                                            val k2 = key()
                                                            val v2 = if (nextHasValue()) { deserializeBoolean() } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                                            map2[k2] = v2
                                                        }
                                                        map2
                                                    }
                    ...
                    when (findNextFieldIndex()) {
                        PAYLOAD_DESCRIPTOR.index -> builder.payload =
                            deserializer.deserializeMap(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextEntry()) {
                                    val k0 = key()
                                    val v0 = if (nextHasValue()) { deserializeFooStructureDocument(deserializer) } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                    map0[k0] = v0
                                }
                                map0
                            }
                        ...
                        val v0 =
                            if (nextHasValue()) {
                                deserializer.deserializeMap(PAYLOAD_C0_DESCRIPTOR) {
                                    ...
                                    while (hasNextEntry()) {
                                        val k1 = key()
                                        val v1 = if (nextHasValue()) { deserializeInt() } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                        map1[k1] = v1
                                    }
                                    map1
                                }
                    ...
                    when (findNextFieldIndex()) {
                        PAYLOAD_DESCRIPTOR.index -> builder.payload =
                            deserializer.deserializeList(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = if (nextHasValue()) { deserializeString().let { SimpleYesNo.fromValue(it) } } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                    col0.add(el0)
                                }
                                col0
                            }
                    ...
                    when (findNextFieldIndex()) {
                        PAYLOAD_DESCRIPTOR.index -> builder.payload =
                            deserializer.deserializeMap(PAYLOAD_DESCRIPTOR) {
                                ...
                                while (hasNextEntry()) {
                                    val k0 = key()
                                    val v0 = if (nextHasValue()) { deserializeString().let { SimpleYesNo.fromValue(it) } } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'payload'.") }
                                    map0[k0] = v0
                                }
                                map0
                            }
                    ...
                    when (findNextFieldIndex()) {
                        FOOBLOBMAP_DESCRIPTOR.index -> builder.fooBlobMap =
                            deserializer.deserializeMap(FOOBLOBMAP_DESCRIPTOR) {
                                ...
                                while (hasNextEntry()) {
                                    val k0 = key()
                                    val v0 = if (nextHasValue()) { deserializeByteArray() } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'fooBlobMap'.") }
                                    map0[k0] = v0
                                }
                                map0
                            }
                    ...
                    when (findNextFieldIndex()) {
                        FOOBLOBLIST_DESCRIPTOR.index -> builder.fooBlobList =
                            deserializer.deserializeList(FOOBLOBLIST_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = if (nextHasValue()) { deserializeByteArray() } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'fooBlobList'.") }
                                    col0.add(el0)
                                }
                                col0
                            }
                    ...
                    when (findNextFieldIndex()) {
                        FOOTIMESTAMPMAP_DESCRIPTOR.index -> builder.fooTimestampMap =
                            deserializer.deserializeMap(FOOTIMESTAMPMAP_DESCRIPTOR) {
                                ...
                                while (hasNextEntry()) {
                                    val k0 = key()
                                    val v0 = if (nextHasValue()) { deserializeInstant(TimestampFormat.EPOCH_SECONDS) } else { deserializeNull(); throw Exception("Invalid server response, missing required field from 'fooTimestampMap'.") }
                                    map0[k0] = v0
                                }
                                map0
                            }
