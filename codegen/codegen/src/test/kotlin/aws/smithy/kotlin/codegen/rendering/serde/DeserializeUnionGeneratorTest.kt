                    ...
                    when(findNextFieldIndex()) {
                        UNIONLIST_DESCRIPTOR.index -> value =
                            deserializer.deserializeList(UNIONLIST_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = if (nextHasValue()) { deserializeMyAggregateUnionDocument(deserializer) } else { throw DeserializationException("Invalid server response, missing required field from 'unionList'.") }
                                    col0.add(el0)
                                }
                        ...
                        UNIONMAP_DESCRIPTOR.index -> value =
                            deserializer.deserializeMap(UNIONMAP_DESCRIPTOR) {
                                ...
                                while (hasNextEntry()) {
                                    val k0 = key()
                                    val v0 = if (nextHasValue()) { deserializeMyAggregateUnionDocument(deserializer) } else { throw DeserializationException("Invalid server response, missing required field from 'unionMap'.") }
                                    map0[k0] = v0
                                }
                    ...
                    when(findNextFieldIndex()) {
                        INTLISTVAL_DESCRIPTOR.index -> value =
                            deserializer.deserializeList(INTLISTVAL_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = if (nextHasValue()) { deserializeInt() } else { throw DeserializationException("Invalid server response, missing required field from 'intListVal'.") }
                                    col0.add(el0)
                                }
                            ...
                            deserializer.deserializeMap(STRMAPVAL_DESCRIPTOR) {
                                ...
                                while (hasNextEntry()) {
                                    ...
                                    val v0 =
                                            ...
                                            deserializer.deserializeList(STRMAPVAL_C0_DESCRIPTOR) {
                                                ...
                                                while (hasNextElement()) {
                                                    val el1 = deserializer.deserializeMap(STRMAPVAL_C1_DESCRIPTOR) {
                                                        ...
                                                        while (hasNextEntry()) {
                                                            val k2 = key()
                                                            val v2 = if (nextHasValue()) { deserializeBarUnionDocument(deserializer) } else { throw DeserializationException("Invalid server response, missing required field from 'strMapVal'.") }
                                                            map2[k2] = v2
                                                        }
                                                        map2
                                                    }
                                        ...
                                        } else { throw DeserializationException("Invalid server response, missing required field from 'strMapVal'.") }
                    ...
                    when(findNextFieldIndex()) {
                        ...
                        INTLIST_DESCRIPTOR.index -> value =
                            deserializer.deserializeList(INTLIST_DESCRIPTOR) {
                                val col0 = mutableListOf<Int>()
                                while (hasNextElement()) {
                                    val el0 = if (nextHasValue()) { deserializeInt() } else { throw DeserializationException("Invalid server response, missing required field from 'intList'.") }
                                    col0.add(el0)
                                }
                            ...
                            deserializer.deserializeList(LISTOFINTLIST_DESCRIPTOR) {
                                ...
                                while (hasNextElement()) {
                                    val el0 = deserializer.deserializeList(LISTOFINTLIST_C0_DESCRIPTOR) {
                                        ...
                                        while (hasNextElement()) {
                                            val el1 = if (nextHasValue()) { deserializeInt() } else { throw DeserializationException("Invalid server response, missing required field from 'listOfIntList'.") }
                                            col1.add(el1)
                                        }
                                        col1
                                    }
                                    ...
                                    val v0 =
                                        if (nextHasValue()) {
                                            deserializer.deserializeList(MAPOFLISTS_C0_DESCRIPTOR) {
                                                val col1 = mutableListOf<Int>()
                                                while (hasNextElement()) {
                                                    val el1 = if (nextHasValue()) { deserializeInt() } else { throw DeserializationException("Invalid server response, missing required field from 'mapOfLists'.") }
                                                    col1.add(el1)
                                                }
                                                col1
                                            }
                                        } else { throw DeserializationException("Invalid server response, missing required field from 'mapOfLists'.") }
