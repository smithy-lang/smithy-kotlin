 ...
 */
open class ProtocolTestErrorGenerator protected constructor(builder: HttpProtocolUnitTestErrorGenerator.Builder) :
    HttpProtocolUnitTestErrorGenerator(builder) {
