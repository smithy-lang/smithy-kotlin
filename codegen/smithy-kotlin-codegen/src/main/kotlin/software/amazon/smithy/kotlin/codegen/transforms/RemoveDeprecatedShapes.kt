 ...
 */
package software.amazon.smithy.kotlin.codegen.transforms
...
class RemoveDeprecatedShapes : ConfigurableProjectionTransformer<RemoveDeprecatedShapes.Config>() {
    ...
    override fun getName(): String = "awsSmithyKotlinRemoveDeprecatedShapes"
 ...
 */
internal fun String.toLocalDate(): LocalDate? = try {
    LocalDate.parse(this, DEPRECATED_SINCE_DATE_FORMATTER)
