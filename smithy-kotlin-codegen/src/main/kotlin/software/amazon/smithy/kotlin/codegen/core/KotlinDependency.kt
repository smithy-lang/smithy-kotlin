...
data class KotlinDependency(
    ...
    companion object {
        ...
        val AWS_SIGNING_STANDARD = KotlinDependency(GradleConfiguration.Implementation, "$RUNTIME_ROOT_NS.auth.awssigning.standard", RUNTIME_GROUP, "aws-signing-standard", RUNTIME_VERSION)
