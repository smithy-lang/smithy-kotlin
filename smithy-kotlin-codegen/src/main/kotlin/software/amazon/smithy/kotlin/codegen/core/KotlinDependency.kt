...
data class KotlinDependency(
    ...
    companion object {
        ...
        val AWS_CREDENTIALS = KotlinDependency(GradleConfiguration.Implementation, "$RUNTIME_ROOT_NS.auth.credentials.awscredentials", RUNTIME_GROUP, "aws-credentials", RUNTIME_VERSION)
        val AWS_SIGNING_COMMON = KotlinDependency(GradleConfiguration.Implementation, "$RUNTIME_ROOT_NS.auth.signing.awssigning.common", RUNTIME_GROUP, "aws-signing-common", RUNTIME_VERSION)
        val AWS_SIGNING_CRT = KotlinDependency(GradleConfiguration.Implementation, "$RUNTIME_ROOT_NS.auth.signing.awssigning.crt", RUNTIME_GROUP, "aws-signing-crt", RUNTIME_VERSION)
