...
// val expectedContents = """
// class PrimitiveShapesOperationSerializer(val input: PrimitiveShapes) : HttpSerialize {
//
//    companion object {
//        private val BBOOL_DESCRIPTOR = SdkFieldDescriptor("bBool", SerialKind.Boolean)
//        private val BDOUBLE_DESCRIPTOR = SdkFieldDescriptor("bDouble", SerialKind.Double)
//        private val BFLOAT_DESCRIPTOR = SdkFieldDescriptor("bFloat", SerialKind.Float)
//        private val BINT_DESCRIPTOR = SdkFieldDescriptor("bInt", SerialKind.Integer)
//        private val OBJ_DESCRIPTOR = SdkObjectDescriptor.build() {
//            field(BBOOL_DESCRIPTOR)
//            field(BDOUBLE_DESCRIPTOR)
//            field(BFLOAT_DESCRIPTOR)
//            field(BINT_DESCRIPTOR)
//        }
//    }
//
...
//
//        builder.url {
//            path = "/primitiveshapes
//            parameters {
//                if (input.qInt != 0) append("q-int", input.qInt.toString())
//            }
//        }
//
//        builder.headers {
//            if (input.hInt != 0) append("X-a", input.hInt.toString())
//            if (input.hBool != false) append("X-b", input.hBool.toString())
//            if (input.hFloat != 0.0f) append("X-c", input.hFloat.toString())
//            if (input.hLong != 0L) append("X-d", input.hLong.toString())
//        }
//
//        val serializer = serializationContext.serializationProvider()
//        serializer.serializeStruct(OBJ_DESCRIPTOR) {
//            if (input.bBool != false) field(BBOOL_DESCRIPTOR, input.bBool)
//            if (input.bDouble != 0.0) field(BDOUBLE_DESCRIPTOR, input.bDouble)
//            if (input.bFloat != 0.0f) field(BFLOAT_DESCRIPTOR, input.bFloat)
//            if (input.bInt != 0) field(BINT_DESCRIPTOR, input.bInt)
//        }
//
