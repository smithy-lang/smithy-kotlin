...
/**
 * An abstract implementation of a telemetry provider. This class delegates the [trace], [debug], [info], [warn], and
 * [error] methods to a centralized [log] method which accepts [LogLevel] as a parameter. By default, this class uses
 * no-op implementations for all other members unless overridden in a subclass.
 */
