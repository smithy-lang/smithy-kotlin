...
class EventListenerChainTest {
    ...
    private class TestEventListener(val name: String, val eventOrder: MutableList<String>) : EventListener(), Closeable {
        var closed = false
    ...
    fun testMixedEvents() {
        ...
        chain.responseHeadersEnd(call, Response.Builder()
