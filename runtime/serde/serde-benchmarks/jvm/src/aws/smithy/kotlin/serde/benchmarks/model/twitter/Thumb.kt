...
class Thumb private constructor(builder: BuilderImpl) {
    val h: Int? = builder.h
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): Thumb = BuilderImpl().apply(block).build()
    }
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): Thumb = BuilderImpl(this).apply(block).build()
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: Thumb) : this() {
            this.h = x.h
            this.resize = x.resize
            this.w = x.w
        }

        override fun build(): Thumb = Thumb(this)
