...
class Status private constructor(builder: BuilderImpl) {
    ...
    interface DslBuilder {
        ...
        fun build(): Status
        /**
         * construct an [aws.smithy.kotlin.serde.benchmarks.model.Entities] inside the given [block]
         */
        fun entities(block: Entities.DslBuilder.() -> kotlin.Unit) {
            this.entities = Entities.invoke(block)
        }
        /**
         * construct an [aws.smithy.kotlin.serde.benchmarks.model.User] inside the given [block]
         */
