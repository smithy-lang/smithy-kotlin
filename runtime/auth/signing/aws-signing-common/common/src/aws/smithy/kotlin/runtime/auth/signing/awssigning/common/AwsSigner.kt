...
interface AwsSigner {
     ...
     */
    suspend fun sign(request: HttpRequest, config: AwsSigningConfig): AwsSigningResult
     ...
     */
    suspend fun signChunk(chunkBody: ByteArray, prevSignature: ByteArray, config: AwsSigningConfig): AwsSigningResult
}
