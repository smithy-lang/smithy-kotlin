...
import aws.smithy.kotlin.runtime.auth.signing.awssigning.common.middleware.AwsSigningMiddleware
...
private val defaultTestCredentialsProvider =
    StaticCredentialsProvider(Credentials("AKIDEXAMPLE", "wJalrXUtnFEMI/K7MDENG+bPxRfiCYEXAMPLEKEY"))
...
actual abstract class SigningSuiteTestBase : HasSigner {
     ...
     */
    private fun testSigv4Middleware(tests: List<Sigv4TestSuiteTest>): Unit = runBlocking {
        tests.forEach { test ->
            try {
