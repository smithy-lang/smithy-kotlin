...
public class SigV4AsymmetricAuthScheme(
    ...
    override fun identityProvider(identityProviderConfig: IdentityProviderConfig): IdentityProvider = identityProviderConfig.identityProviderForScheme(AuthSchemeId.AwsSigV4Asymmetric)
