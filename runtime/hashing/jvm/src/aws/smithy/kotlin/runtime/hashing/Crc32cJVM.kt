...
private class CRC32C : Checksum {
    ...
    override fun reset() { crc = 0xffffffff }

    override fun update(b: ByteArray, offset: Int, length: Int) {
        var localCrc = crc
        var off = offset
        var len = length
    ...
    override fun getValue(): Long = crc.inv() and 0xffffffffL
    ...
    companion object {
        @JvmStatic
        private val T8_0_start: Int = 0 * 256

        @JvmStatic
        private val T8_1_start: Int = 1 * 256

        @JvmStatic
        private val T8_2_start: Int = 2 * 256

        @JvmStatic
        private val T8_3_start: Int = 3 * 256

        @JvmStatic
        private val T8_4_start: Int = 4 * 256

        @JvmStatic
        private val T8_5_start: Int = 5 * 256

        @JvmStatic
        private val T8_6_start: Int = 6 * 256

        @JvmStatic
        private val T8_7_start: Int = 7 * 256
        ...
        @JvmStatic
        private val T: List<Long> = listOf(
            /* T8_0 */
