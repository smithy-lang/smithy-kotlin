...
private class CRC32CImpl {
    ...
    companion object {
        ...
        private const val T8_1_start: Int = 1 * 256

        private const val T8_2_start: Int = 2 * 256

        private const val T8_3_start: Int = 3 * 256

        private const val T8_4_start: Int = 4 * 256

        private const val T8_5_start: Int = 5 * 256

        private const val T8_6_start: Int = 6 * 256

        private const val T8_7_start: Int = 7 * 256
