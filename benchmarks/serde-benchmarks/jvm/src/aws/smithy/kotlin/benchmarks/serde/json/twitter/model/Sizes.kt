...
class Sizes private constructor(builder: BuilderImpl) {
    ...
    interface DslBuilder {
        ...
        fun build(): Sizes
        /**
         * construct an [aws.smithy.kotlin.benchmarks.serde.json.twitter.model.Large] inside the given [block]
         */
        fun large(block: Large.DslBuilder.() -> kotlin.Unit) {
            this.large = Large.invoke(block)
        }
        /**
         * construct an [aws.smithy.kotlin.benchmarks.serde.json.twitter.model.Medium] inside the given [block]
         */
        fun medium(block: Medium.DslBuilder.() -> kotlin.Unit) {
            this.medium = Medium.invoke(block)
        }
        /**
         * construct an [aws.smithy.kotlin.benchmarks.serde.json.twitter.model.Small] inside the given [block]
         */
        fun small(block: Small.DslBuilder.() -> kotlin.Unit) {
            this.small = Small.invoke(block)
        }
        /**
         * construct an [aws.smithy.kotlin.benchmarks.serde.json.twitter.model.Thumb] inside the given [block]
         */
